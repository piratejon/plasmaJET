...
#self.assertIsNotNone(play.load_game_object(LOAD_LIBRARY_ARGUMENT))
  ...
  def test_store_board(self):
    ...
    play.store_new_board([' ','x','o','x','x',' ','o','o','x'])
    self.assertEqual(play.game.getSpace(0) == ' ')
    self.assertEqual(play.game.getSpace(1) == 'x')
    self.assertEqual(play.game.getSpace(2) == 'o')
    self.assertEqual(play.game.getSpace(3) == 'x')
    self.assertEqual(play.game.getSpace(4) == 'x')
    self.assertEqual(play.game.getSpace(5) == ' ')
    self.assertEqual(play.game.getSpace(6) == 'o')
    self.assertEqual(play.game.getSpace(7) == 'o')
    self.assertEqual(play.game.getSpace(8) == 'x')

    play.store_new_board(['o','x',' ','o','x','o','x','o','x'])
    self.assertEqual(play.game.getSpace(0) == 'o')
    self.assertEqual(play.game.getSpace(1) == 'x')
    self.assertEqual(play.game.getSpace(2) == ' ')
    self.assertEqual(play.game.getSpace(3) == 'o')
    self.assertEqual(play.game.getSpace(4) == 'x')
    self.assertEqual(play.game.getSpace(5) == 'o')
    self.assertEqual(play.game.getSpace(6) == 'x')
    self.assertEqual(play.game.getSpace(7) == 'o')
